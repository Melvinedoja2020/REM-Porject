    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(blank=True, choices=[('Prospective Buyer/Tenant', 'Prospective Buyer/Tenant'), ('Agent', 'Agent'), ('Real Estate Owner', 'Real Estate Owner')], max_length=50, null=True, verbose_name='Role')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_properties_owned', models.IntegerField(blank=True, default=0, null=True)),
                ('phone_no', models.CharField(blank=True, max_length=15, null=True)),
                ('address', models.TextField(blank=True, null=True)),
                ('profile_picture', models.ImageField(blank=True, null=True, upload_to=core.helper.media.MediaHelper.get_image_upload_path)),
                ('user', auto_prefetch.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='real_estate_profile', to=settings.AUTH_USER_MODEL)),
            ],
            options={
