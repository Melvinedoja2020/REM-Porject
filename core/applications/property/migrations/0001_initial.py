    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover_image', models.ImageField(blank=True, null=True, upload_to=core.helpers.media.MediaHelper.get_image_upload_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('image', models.ImageField(upload_to=core.helpers.media.MediaHelper.get_image_upload_path)),
            ],
            options={
                'abstract': False,
                'base_manager_name': 'prefetch_manager',
